...
public class ListPerformanceTest {
    ...
    @Benchmark
    public void arrayListDefaultConstructor(Blackhole bh) {
        ArrayList<Integer> list = new ArrayList<>();
        bh.consume(list);
    }

    @Benchmark
    public void arrayListCapacityConstructor(Blackhole bh) {
        ArrayList<Integer> list = new ArrayList<>(size);
        bh.consume(list);
    }

    @Benchmark
    public void arrayListCollectionConstructor(Blackhole bh) {
        ArrayList<Integer> list = new ArrayList<>(sampleList);
        bh.consume(list);
    }
    ...
    @Benchmark
    public void arrayListAddIndex(Blackhole bh) {
        ArrayList<Integer> list = new ArrayList<>();
        for (int i = 0; i < size; i++) {
            list.add(0, i);
        }
    ...
    @Benchmark
    public void arrayListAddAllIndex(Blackhole bh) {
        ArrayList<Integer> list = new ArrayList<>();
    ...
    @Benchmark
    public void arrayListClear(Blackhole bh) {
        ArrayList<Integer> list = new ArrayList<>(sampleList);
        list.clear();
        bh.consume(list);
    }
    ...
    @Benchmark
    public void arrayListContainsAll(Blackhole bh) {
        ArrayList<Integer> list = new ArrayList<>(sampleList);
    ...
    @Benchmark
    public void arrayListIsEmpty(Blackhole bh) {
        ArrayList<Integer> list = new ArrayList<>(sampleList);
        bh.consume(list.isEmpty());
    }

    @Benchmark
    public void arrayListIteratorNext(Blackhole bh) {
        ArrayList<Integer> list = new ArrayList<>(sampleList);
    ...
    @Benchmark
    public void arrayListListIteratorAdd(Blackhole bh) {
        ArrayList<Integer> list = new ArrayList<>();
    ...
    @Benchmark
    public void arrayListListIteratorSet(Blackhole bh) {
        ArrayList<Integer> list = new ArrayList<>(sampleList);
        var lit = list.listIterator();
        while (lit.hasNext()) {
            lit.next();
    ...
    @Benchmark
    public void arrayListListIteratorRemove(Blackhole bh) {
        ArrayList<Integer> list = new ArrayList<>(sampleList);
        var lit = list.listIterator();
        while (lit.hasNext()) {
            lit.next();
    ...
    @Benchmark
    public void arrayListLastIndexOf(Blackhole bh) {
        ArrayList<Integer> list = new ArrayList<>(sampleList);
        int cap = Math.min(size, 10000);
        for (int i = 0; i < cap; i++) {
    ...
    @Benchmark
    public void arrayListRemoveIndex(Blackhole bh) {
        ArrayList<Integer> list = new ArrayList<>(sampleList);
    ...
    @Benchmark
    public void arrayListRemoveObject(Blackhole bh) {
        ArrayList<Integer> list = new ArrayList<>(sampleList);
        for (int i = 0; i < size; i++) {
    ...
    @Benchmark
    public void arrayListRemoveAll(Blackhole bh) {
        ArrayList<Integer> list = new ArrayList<>(sampleList);
    ...
    @Benchmark
    public void arrayListRetainAll(Blackhole bh) {
        ArrayList<Integer> list = new ArrayList<>(sampleList);
    ...
    @Benchmark
    public void arrayListSubList(Blackhole bh) {
        ArrayList<Integer> list = new ArrayList<>(sampleList);
        bh.consume(list.subList(0, Math.min(size, 1)).size());
    }

    @Benchmark
    public void arrayListToArray(Blackhole bh) {
        ArrayList<Integer> list = new ArrayList<>(sampleList);
        bh.consume(list.toArray());
    }

    @Benchmark
    public void arrayListEquals(Blackhole bh) {
        ArrayList<Integer> list = new ArrayList<>(sampleList);
        bh.consume(list.equals(sampleList));
    }

    @Benchmark
    public void arrayListHashCode(Blackhole bh) {
        ArrayList<Integer> list = new ArrayList<>(sampleList);
        bh.consume(list.hashCode());
    }

    @Benchmark
    public void arrayListToString(Blackhole bh) {
        ArrayList<Integer> list = new ArrayList<>(sampleList);
    ...
    public static void main(String[] args) throws org.openjdk.jmh.runner.RunnerException {
        org.openjdk.jmh.runner.options.Options opt = new org.openjdk.jmh.runner.options.OptionsBuilder()
                ...
                .warmupIterations(3)
                .forks(1)
                .result("ArrayList_performance_results.csv")
    ...
    private static void writeCustomCsv(java.util.Collection<org.openjdk.jmh.results.RunResult> results) {
        try (java.io.FileWriter writer = new java.io.FileWriter("ArrayList_jmh_performance.csv")) {
            ...
            System.out.println("JMH Performance report saved: ArrayList_jmh_performance.csv");
